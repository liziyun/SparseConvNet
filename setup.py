...
extra_link = ['-lHalide', '-ldl', '-lz'] if use_halide else []
include_dirs = [conda_include_dir, this_dir+'/sparseconvnet/SCN/', halide_include_dir] if use_halide else [conda_include_dir, this_dir+'/sparseconvnet/SCN/']
build_dirs =  ['sparseconvnet/SCN/pybind.cpp', halide_mul, 'sparseconvnet/SCN/sparseconvnet_cpu.cpp'] if use_halide else ['sparseconvnet/SCN/pybind.cpp', 'sparseconvnet/SCN/sparseconvnet_cpu.cpp']
